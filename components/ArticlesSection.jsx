...
function Articles() {
  return (
    <section className="container mx-auto px-4 py-16">
      <div className="grid md:grid-cols-3 sm:col-span-2 gap-6">
        {/* Image */}
        <div className="md:col-span-2 sm:col-span-1 md:mr-6">
          <Image
        ...
        <div className="">
          ...
          <Link
            href="/"
            className="uppercase font-bold text-blue-400 text-xs hover:text-slate-600 ease-linear duration-100 py-2"
          >
            Read more
          </Link>
        </div>
      </div>
      <div className="flex flex-wrap items-center justify-center font-medium hover:text-blue-700 ease-linear duration-75 py-10">
